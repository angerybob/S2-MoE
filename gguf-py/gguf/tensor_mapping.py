...
class TensorNameMap:
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_NORM: (
            ...
            "midlayer.input_layernorm",                             # EAGLE
        ),
        ...
        MODEL_TENSOR.ATTN_Q: (
            ...
            "midlayer.self_attn.q_proj",                                 # EAGLE
        ),
        ...
        MODEL_TENSOR.ATTN_K: (
            ...
            "midlayer.self_attn.k_proj",                              # EAGLE
        ),
        ...
        MODEL_TENSOR.ATTN_V: (
            ...
            "midlayer.self_attn.v_proj",                                # EAGLE
        ),
        ...
        MODEL_TENSOR.ATTN_OUT: (
            ...
            "midlayer.self_attn.o_proj",                                   # EAGLE
        ),
        ...
        MODEL_TENSOR.FFN_NORM: (
            ...
            "midlayer.post_attention_layernorm",                             # EAGLE
