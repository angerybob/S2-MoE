...
class GGUFWriter:
    ...
    def add_eagle_d2t_map(self, d2t_map: Sequence[int]) -> None:
        """Add EAGLE draft-to-target token mapping."""
        self.add_array("eagle.d2t_map", d2t_map)

    def add_eagle_t2d_map(self, t2d_map: Sequence[bool]) -> None:
        """Add EAGLE target-to-draft validity mapping."""
        self.add_array("eagle.t2d_map", t2d_map)
