...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_MOE_REUSE_STRENGTH,                "%s.moe_reuse_strength"                },
    { LLM_KV_MOE_REUSE_EXPERT_CAP,              "%s.moe_reuse_expert_cap"              },
    { LLM_KV_DFT_EXIT_LAYER,                    "%s.dft_exit_layer"                    },
    ...
    // EAGLE vocabulary mappings
    { LLM_KV_EAGLE_D2T_MAP,        "eagle.d2t_map"        },
    ...
    { LLM_KV_EAGLE3_NORM_BEFORE_FC,     "%s.norm_before_fc"     },
...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
    ...
    },
    {
        LLM_ARCH_EAGLE,
        {
            ...
            { LLM_TENSOR_OUTPUT,          "output"         },
            { LLM_TENSOR_FC,              "fc"             },
            { LLM_TENSOR_EAGLE_INPUT_NORM,"input_norm"     },
            { LLM_TENSOR_EAGLE_D2T,       "d2t"            },
            // midlayer（按层）
            { LLM_TENSOR_ATTN_NORM,       "blk.%d.attn_norm"      },
            { LLM_TENSOR_ATTN_NORM_2,     "blk.%d.hidden_norm"    },
            { LLM_TENSOR_ATTN_Q,          "blk.%d.attn_q" },
            { LLM_TENSOR_ATTN_K,          "blk.%d.attn_k" },
            { LLM_TENSOR_ATTN_V,          "blk.%d.attn_v" },
            { LLM_TENSOR_ATTN_OUT,        "blk.%d.attn_output" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_FC,                        {LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_EAGLE_INPUT_NORM,          {LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL}},
    {LLM_TENSOR_EAGLE_D2T,                 {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_GET_ROWS}},
};
...
llm_arch llm_arch_from_string(const std::string & name) {
    if (name == "eagle3-draft") {
        return LLM_ARCH_EAGLE;
    }
