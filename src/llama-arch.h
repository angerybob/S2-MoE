...
enum llm_kv {
    ...
    LLM_KV_MOE_REUSE_STRENGTH,
    LLM_KV_MOE_REUSE_EXPERT_CAP,
    LLM_KV_DFT_EXIT_LAYER,
    ...
    LLM_KV_EAGLE_D2T_MAP,
    LLM_KV_EAGLE_T2D_MAP,
    LLM_KV_EAGLE3_EXTRACT_LAYERS,
    LLM_KV_EAGLE3_TARGET_HIDDEN_SIZE,
    LLM_KV_EAGLE3_NORM_BEFORE_FC,
    LLM_KV_DFLASH_BLOCK_SIZE,
    LLM_KV_DFLASH_MASK_TOKEN_ID,
    LLM_KV_DFLASH_TARGET_LAYERS,
    LLM_KV_DFLASH_PROJECTOR_TYPE,
    LLM_KV_DFLASH_PURE_DRAFT_PREFIX_LEN,
    LLM_KV_DFLASH_SHIFT_LABEL,
};
