...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"--n-expert-used"}, "N",
        "override the number of active MoE experts for the main model; <= 0 uses model default",
        [](common_params & params, const std::string & value) {
            params.n_expert_used = std::stoi(value);
        }
    ));
    add_opt(common_arg(
        {"--gpu-experts-json"}, "FILE",
        "JSON file with gpu_experts [[layer, expert], ...] to keep resident in VRAM",
        [](common_params & params, const std::string & value) {
            params.gpu_experts_json = value;
        }
    ));
    add_opt(common_arg(
        {"--dft-exit-layer"}, "N",
        "cap the number of experts encouraged to activate per MoE call; 0 disables, negative uses model default",
        [](common_params & params, const std::string & value) {
            params.dft_exit_layer = std::stoi(value);
        }
    ).set_env("LLAMA_ARG_MOE_REUSE_EXPERT_CAP"));
    add_opt(common_arg(
        {"--draft-share-kv"},
    ...
    add_opt(common_arg(
        {"--moe-utility-spec"},
        "enable Cascade-style utility-driven adaptive draft length",
        [](common_params & params) {
    ...
    add_opt(common_arg(
        ...
        string_format("utility-spec: draft samples per candidate during test phase (default: %d)", params.speculative.utility_test_iters),
        [](common_params & params, int value) {
    ...
    add_opt(common_arg(
        ...
        string_format("utility-spec: decode iterations per set phase after choosing best draft length (default: %d)", params.speculative.utility_set_iters),
        [](common_params & params, int value) {
    ...
    add_opt(common_arg(
        {"--prune"}, "N",
        "enable speculative draft tree pruning using marginal benefit/cost (0 = off, 1 = on)",
        [](common_params & params, int value) {
    ...
    add_opt(common_arg(
        {"--prune-budget"}, "N",
        string_format("pruning: expert transfer budget (default: %.1f)", (double)params.sprune.budget_b),
        [](common_params & params, const std::string & value) {
    ...
    add_opt(common_arg(
        {"--prune-m-route"}, "N",
        string_format("pruning: route count used for marginal-cost estimate (default: %d)", params.sprune.m_route),
        [](common_params & params, int value) {
    ...
    add_opt(common_arg(
        {"--prune-tpot"}, "N",
        string_format("pruning: estimated target token latency benefit in ms (default: %.1f)", (double)params.sprune.tpot),
        [](common_params & params, const std::string & value) {
    ...
    add_opt(common_arg(
        {"--prune-eps"}, "N",
        string_format("pruning: cost denominator epsilon (default: %.1f)", (double)params.sprune.eps),
        [](common_params & params, const std::string & value) {
    ...
    add_opt(common_arg(
        ...
        string_format("pruning: per-expert transfer size in MiB (default: %.3f)", (double)params.sprune.expert_bytes),
        [](common_params & params, const std::string & value) {
    ...
    add_opt(common_arg(
        {"--prune-bandwidth"}, "N",
        string_format("pruning: transfer bandwidth in MiB/ms (default: %.1f)", (double)params.sprune.bandwidth),
        [](common_params & params, const std::string & value) {
    ...
    add_opt(common_arg(
        {"--prune-conf-thresh"}, "F",
        string_format("pruning: confidence threshold for first-step candidates (default: %.2f)", (double)params.sprune.conf_thresh),
        [](common_params & params, const std::string & value) {
    ...
    add_opt(common_arg(
        ...
        string_format("pruning: candidate score threshold (default: %.2f)", (double)params.sprune.score_thresh),
        [](common_params & params, const std::string & value) {
    ...
    add_opt(common_arg(
        {"--draft-n-expert-used"}, "N",
        "override the number of active MoE experts for the draft model",
        [](common_params & params, int value) {
            params.speculative.n_expert_used = value;
        }
    ).set_examples({LLAMA_EXAMPLE_SPECULATIVE}));
    add_opt(common_arg(
